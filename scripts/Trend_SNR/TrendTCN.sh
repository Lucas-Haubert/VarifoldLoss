...
do
    script_name_str="Rob_Trend_TrendTCN_MSE"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendTCN_DILATE"
...
do
    for snr in "${snr_values[@]}"
    do
        script_name_str="Rob_Trend_TrendTCN_Soft_DTW"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendTCN_Distrib"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendTCN_Current"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendTCN_UnorVar"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendTCN_OrVar"
