...
do
    script_name_str="Rob_Trend_TrendLSTM_MSE"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendLSTM_DILATE"
...
do
    for snr in "${snr_values[@]}"
    do
        script_name_str="Rob_Trend_TrendLSTM_Soft_DTW"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendLSTM_Distrib"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendLSTM_Current"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendLSTM_UnorVar"
...
for snr in "${snr_values[@]}"
do
    script_name_str="Rob_Trend_TrendLSTM_OrVar"
