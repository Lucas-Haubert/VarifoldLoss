#!/bin/bash
#SBATCH --job-name=TUESDAY_MEETING_iTransformer_electricity_VARIFOLD_sigma_1_1_05sqrt_05sqrt_B_16_lr_0dot001
...
#   --model_id TUESDAY_MEETING_iTransformer_traffic_MSE_B_16_lr_0dot001 \
#   --model $model_name \
#   --loss 'MSE' \
#   --train_epochs 20 \
#   --patience 5 \
